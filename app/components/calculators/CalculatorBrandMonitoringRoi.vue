...
const result = computed(() => calculate("brand-monitoring-roi", state));
</script>
<template>
    ...
    <div class="rh-ri-wrap">
      <div class="rh-ri-inner">
        <div class="rh-ri-form">
          ...
          <span class="rh-ri-title">Brand Mention ROI Calculator</span>
          <span class="rh-ri-sub"
            >See what your brand mentions are worth in paid-media terms — and
            how much you're losing to slow response times and negative
            sentiment.</span
          >
          <div class="rh-ri-q">
            <span class="rh-ri-q-text">Brand mentions per month</span>
            <span class="rh-ri-q-hint"
              >All channels combined — press, social, forums, reviews</span
            >
            <div class="rh-ri-input-row">
              <input
                ...
                id="rh-mentions"
                min="0"
                v-model.number="state['rh-mentions']"
                aria-label="mentions"
              />
              <span class="rh-ri-input-suffix">mentions / mo</span>
            </div>
          </div>
          <div class="rh-ri-q">
            <span class="rh-ri-q-text">Average reach per mention</span>
            <span class="rh-ri-q-hint"
              >Estimated impressions a typical mention generates</span
            >
            <div class="rh-ri-input-row">
              <input
                type="number"
                id="rh-impressions"
                min="0"
                v-model.number="state['rh-impressions']"
                aria-label="impressions"
              />
              <span class="rh-ri-input-suffix">impressions</span>
            </div>
          </div>
          <div class="rh-ri-q">
            <span class="rh-ri-q-text">Your paid CPM</span>
            <span class="rh-ri-q-hint"
              >What you pay per 1,000 ad impressions in your main channel</span
            >
            <div class="rh-ri-input-row">
              <input
                type="number"
                id="rh-cpm"
                min="0"
                v-model.number="state['rh-cpm']"
                aria-label="cpm"
              />
              <span class="rh-ri-input-suffix">$ per 1,000 impressions</span>
            </div>
          </div>
          <div class="rh-ri-q">
            <div class="rh-ri-slider-row">
              <span class="rh-ri-slider-val" id="rh-neg-val">{{
                state["rh-negative"] + "%"
              }}</span>
              <span class="rh-ri-slider-hint">Negative mentions</span>
            </div>
            <input
              type="range"
              id="rh-negative"
              ...
              max="100"
              step="1"
              v-model.number="state['rh-negative']"
              aria-label="negative"
            />
          ...
          <div class="rh-ri-q">
            <div class="rh-ri-slider-row">
              <span class="rh-ri-slider-val" id="rh-resp-val">{{
                state["rh-response"] + " h"
              }}</span>
              <span class="rh-ri-slider-hint">Avg response time</span>
            </div>
            <input
              type="range"
              id="rh-response"
              ...
              max="168"
              step="1"
              v-model.number="state['rh-response']"
              aria-label="response"
            />
            <div class="rh-ri-slider-marks">
              <span>Real-time</span><span>1 week+</span>
            </div>
          </div>
        ...
        <div class="rh-ri-result">
          <div class="rh-ri-result-empty" id="rh-ri-empty" v-if="!submitted">
            <span class="rh-ri-result-empty-text"
              >Fill in your monitoring numbers on the left — the value breakdown
              appears here</span
            >
          </div>
